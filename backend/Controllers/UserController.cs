...
namespace AuctionBackend.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ApplicationUser>>> GetUsers()
        {
            ...
            //_logger.LogInformation(message: $"User: {user.Identity.Name}, Roles: {string.Join(", ", user.FindAll(ClaimTypes.Role).Select(c => c.Value))}");
            _logger.LogInformation($"User: {user.Identity.Name}, Roles: {string.Join(", ", user.FindAll(ClaimTypes.Role).Select(c => c.Value))}");
